              ...
              <div className="flex w-full flex-col gap-4 p-4 md:gap-6 md:p-6">
                ...
                <div className="flex w-full flex-col items-start justify-start gap-2">
                  ...
                  <select
                    ...
                    autoComplete="false"
                    className="w-full border-[1px] border-white bg-black p-4 text-white placeholder:text-gray-500 px-3"
                  >
                    <option className="px-3" value="0">John Doe</option>
                    <option className="px-3" value="1">Jane Doe</option>
                    <option className="px-3" value="2">Mark Smith</option>
                    <option className="px-3" value="3">Tiger Woods</option>
                  </select>
                </div>
                <div className="flex w-full flex-col items-start justify-start gap-2">
                  <label className="text-xs text-slate-200">
