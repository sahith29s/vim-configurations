...
if(discriminant < 0 ):
    ...
    print((-secondCoefficient + (discriminant**1/2)))
    firstRoot = (-secondCoefficient + (discriminant**1/2))/2 * firstCoefficient
    secondRoot = (-secondCoefficient - (discriminant**1/2))/2 * firstCoefficient
