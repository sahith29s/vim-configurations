    ...
    return (
        <>
            ...
            <div className="container mx-auto mt-10">
                ...
                {/* textarea  */}
                <textarea value={text} name="" onChange={(e) => { setText(e.target.value) }} className="bg-slate-200 w-[100%] h-80 resize-none " id="" cols="30" rows="10"></textarea>
