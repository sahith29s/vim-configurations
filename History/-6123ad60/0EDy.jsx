        ...
        <>
            ...
            <div className="container mx-auto mt-10">
                ...
                <div className="allButtonInsideThis mt-3">
                    ...
                    <button onClick={handleRemoveSpaces} className="capitalize mx-1 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">copy text</button>
