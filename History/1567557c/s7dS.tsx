            ...
            <div className="flex flex-col items-center mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-800 mt-4">
                    <TypeAnimation
                        ...
                        wrapper="span"
                        speed={8}
                        className="text-purple-600 fonti"
                        repeat={Infinity}
                    />
                </h1>
            </div>
            <div className="sm:text-left">
                <div className="text-[3rem] fonti">Hey,</div>
                <div className="text-[3rem] fonti">This is <span className="text-orange-500 ">Sahith</span></div>
                <div className="text-[3rem] fonti">Into Tech? </div>
