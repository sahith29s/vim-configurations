                    ...
                    <div key={video.id} className="bg-white p-4 rounded-lg shadow-md">
                        <div className="aspect-w-16 aspect-h-9 mb-4">
                            {/* <iframe
                                ...
                                allowFullScreen
                            /> */}
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/t1OGhTpWqNg?si=P1yhivU9U0u8W3Ob" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
