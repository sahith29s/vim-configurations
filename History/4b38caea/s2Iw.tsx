...
const Home = () => {
    return (
        <div>
            <h1 className="text-4xl font-bold my-4">Featured Videos</h1>
            <div className="grid grid-cols-1 w-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {videos.map(video => (
                    <div key={video.id} className="bg-white w-auto p-4 rounded-lg shadow-md">
                        <div className="aspect-w-16 aspect-h-9 w-[50rem] mb-4">
                            {/* <iframe
                                title={video.title}
