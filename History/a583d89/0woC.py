...
if(discriminant < 0 ):
    ...
    print(discriminant**0.5)
    firstRoot = (-secondCoefficient + (discriminant**0.5))/(2 * firstCoefficient)
    secondRoot = (-secondCoefficient - (discriminant**0.5))/(2 * firstCoefficient)
    print(f"{firstRoot}  , {secondRoot}")
