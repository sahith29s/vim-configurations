    ...
    return (
        <div className="bg-gradient-to-r pb-5 from-blue-200 to-blue-400 min-h-screen">
            ...
            <section className="max-w-4xl mx-auto mt-8 p-8 bg-white rounded-lg shadow-lg">
                ...
                <div className="">
                    <Link to="/">
                        <FontAwesomeIcon icon={faDiscord} color="black" className="h-8 hover:opacity-70 duration-150 hover:scale-90" />
                    </Link>

                    <Link to="/">
                        <FontAwesomeIcon icon={faChessQueen} color="black" className="h-8 hover:opacity-70 duration-150 hover:scale-90" />
                    </Link>
                    man
