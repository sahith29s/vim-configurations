            ...
            <section className="max-w-4xl mx-auto mt-8 p-8 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex flex-col md:flex-row mb-6">
                    <div className="md:w-1/2 md:mr-4">
                        <img src="https://img.freepik.com/free-photo/3d-portrait-high-school-teenager_23-2150793939.jpg?t=st=1700136870~exp=1700140470~hmac=9adc7c504e8d791b1f1206297f43f7a9662f518ccb7a24da0b2b1e16baa7f4e2&w=360" alt="Student" className="w-full h-[30rem] rounded-lg" />
                    </div>
