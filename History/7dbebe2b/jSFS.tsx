...
const SignUp = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (formData.password === formData.confirmPassword) {
            const dataSendToServer = await fetch('http://localhost:5000', {
                method: 'post',
                ...
                body : {
                    Response { type: "cors", url: "http://localhost:5000/", redirected: false, status: 404, ok: false, statusText: "Not Found", headers: Headers(2), body: ReadableStream, bodyUsed: false }
