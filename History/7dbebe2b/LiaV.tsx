...
const SignUp = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (formData.password === formData.confirmPassword) {
            console.log(formData.password, formData.confirmPassword, formData.email)
            let dataSendToServer = await fetch('http://localhost:5000/signup', {
                method: 'post',
            ...
            dataSendToServer = await dataSendToServer.json()
