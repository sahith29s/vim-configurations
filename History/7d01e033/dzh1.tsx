        ...
        <nav className="bg-gray-800 p-4 sticky top-0">
            <div className="container mx-auto sm:flex justify-between items-center">
                ...
                <div className="flex items-center justify-center">
                    ...
                    <Link className="text-white mr-4 hover:scale-90 duration-200" to="/home">Home</Link>
                    <Link className="text-white mr-4 hover:scale-90 duration-200" to="/aboutme">About</Link>
                    <Link className="text-white mr-4 hover:scale-90 duration-200" to="/contact">Contact</Link>
 duration-200 hover:bg-yellow-500 
