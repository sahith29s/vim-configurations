            ...
            <div className="container mx-auto sm:flex justify-between items-center">
                ...
                <div className="flex items-center justify-center">
                    <Link className='flex justify-center items-center' to="/">
                        ...
                        <span className="text-white text-2xl font-semibold hover:text-purple-500 duration-150"> <span className="text-green-400 text-3xl font-serif" >S</span>ahith</span>
                    </Link>
                </div>
                ...
                <div className="flex items-center justify-center gap-4">
                    ...
                    <Link to="/">
                        <FontAwesomeIcon icon={faDiscord} color="white" className="h-8 hover:opacity-70 duration-150 hover:scale-90" />
                    </Link>

                    <Link target="_sahith" to="https://www.chess.com/member/itsmesahith">
                        <FontAwesomeIcon icon={faChessQueen} color="white" className="h-8 hover:opacity-70 duration-150 hover:scale-90" />
                    </Link>
