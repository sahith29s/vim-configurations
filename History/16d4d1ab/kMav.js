...
router.post("/api/login", async (req, res) => {
    try {
        ...
        let isMatch = await bcrypt.compare(req.body.password,signUpDataForChecking.password)

        if (signUpDataForChecking.email == req.body.email && signUpDataForChecking.username == req.body.username && isMatch) {
