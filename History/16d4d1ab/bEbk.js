...
router.post("/api/contact", async (req, res) => {
    let signUpDataForChecking = signUpData.find({
...
router.post("/api/login", async (req, res) => {
    ...
    if (signUpDataForChecking.email == req.body.email && signUpDataForChecking.username == req.body.username && signUpDataForChecking.password == req.body.email) {
