...
const RegisterPage = () => {
    ...
    const imageToUrlGenerator = async (image) => {
        if (image.type === "image/jpeg" || image.type === "iamge/png") {
            ...
            const imageData = await fetch("https://api.cloudinary.com/v1_1/dpm6uveua/upload/image", {
                method: "post",
                body: formDataVar
            })
        ...
        <div className="container">
            ...
            <Form onSubmit={handleRegister}>
                ...
                <Form.Group controlId="profilePicture">
                    ...
                    <Form.Control
                        className='mt-2 mb-5'
                        onChange={(e) => imageToUrlGenerator(e.target.files[0])}
                        type="file"
