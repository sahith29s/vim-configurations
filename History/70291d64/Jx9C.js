...
// user controller
const userController = require("@/controllers/erpControllers/userController")
...
// //_________________________________________________________________API for Users_____________________
// router.route("/user/create").get((req , res) =>{ res.json("sahith")})
// router.route("/user").get((req, res) => res.json("sahith"))
const { userSignup } = require("../../controllers/erpControllers/userController")
router.route("/user/create").get((req, res) => {
  res.json({ name: "sahith" })
})
