            ...
            <div className="container">
                ...
                <div className="flex justify-between mt-10">
                    ...
                    <div className="w-[45%]">
                        ...
                        <div className="font-bold">We are available globally</div>
                        <div className=''>Since our beginnings in London, we have expanded globally to 12 countries. Our services are available in the following countries: Ireland, UAE, Bahrain, Qatar, Singapore, Kuwait, United Kingdom, Sweden, Netherlands, France, United States, and Denmark.</div>
