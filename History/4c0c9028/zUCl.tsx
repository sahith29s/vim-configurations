            ...
            <div className="container">
                ...
                <div className="flex justify-between mt-10">
                    ...
                    <div className="w-[45%]">
                        ...
                        <div className="subheading mt-5 font-bold">Founded in 2014 in London, Laundryheap is the next generation laundry & dry cleaning company. We offer professional laundry and dry cleaning delivered to your doorstep in as quick as 24 hours.</div>
