            ...
            <div className="container">
                ...
                <div className="flex justify-between mt-10">
                    ...
                    <div className="w-[45%]">
                        ...
                        <div className="subheading mt-5 font-bold text-[1.2rem]">Founded in 2014 in London, Laundryheap is the next generation laundry & dry cleaning company. We offer professional laundry and dry cleaning delivered to your doorstep in as quick as 24 hours.</div>

                        <div className="font-bold mt-10 text-[1rem]">We are available globally</div>
                        <div className="mt-2">Since our beginnings in London, we have expanded globally to 12 countries. Our services are available in the following countries: Ireland, UAE, Bahrain, Qatar, Singapore, Kuwait, United Kingdom, Sweden, Netherlands, France, United States, and Denmark.</div>
                        ...
                        <div className="">Social and environmental sustainability is at the heart of what we do. We are building the largest fleet of electric delivery vehicles and are committed to reducing water, electricity consumption and the amount of packaging.</div>

                        <div className="mt-2">You can read more at our <span>Sustainability page. (this is a link)</span> </div>
                    </div>
