            ...
            <div className="container">
                ...
                <div className="flex justify-between mt-10">
                    ...
                    <div className="w-[45%]">
                        ...
                        <div className="font-bold mt-10 font-[1rem]">We are available globally</div>
                        <div className="mt-5">Since our beginnings in London, we have expanded globally to 12 countries. Our services are available in the following countries: Ireland, UAE, Bahrain, Qatar, Singapore, Kuwait, United Kingdom, Sweden, Netherlands, France, United States, and Denmark.</div>
