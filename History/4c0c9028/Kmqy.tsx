        ...
        <>
            ...
            <div className="container">
                ...
                <div className="flex justify-between mt-10">
                    ...
                    {/* block3 right */}
                    <div className="w-[45%]">
                        <div className="text-left text-[2rem]">Who we are</div>
                        <div className="subheading">Founded in 2014 in London, Laundryheap is the next generation laundry & dry cleaning company. We offer professional laundry and dry cleaning delivered to your doorstep in as quick as 24 hours.</div>
                        <div>We are available globally</div>
                        <div>Since our beginnings in London, we have expanded globally to 12 countries. Our services are available in the following countries: Ireland, UAE, Bahrain, Qatar, Singapore, Kuwait, United Kingdom, Sweden, Netherlands, France, United States, and Denmark.</div>
